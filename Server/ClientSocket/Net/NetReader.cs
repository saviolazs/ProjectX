...
namespace ClientSocket
{
    ...
    public class NetReader
    {
        ...
        public bool pushNetStream(byte[] netBytes, NetworkType type)
        {
            ...
            {
                Console.WriteLine(" Failed: NetReader: pushNetStream , nStreamSize error " + "nStreamSize" + nStreamSize + "this.bytes.Length" + this.bytes.Length);
                return false;
            }
        ...
        public bool recordBegin()
        {
            ...
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: recordBegin ");
                return false;
            }
        ...
        public byte getByte()
        {
            ...
            {
                Console.WriteLine(" Failed: 长度越界  NetReader: getBYTE ");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getBYTE");
                    return 0;
                }
        ...
        public sbyte getSByte()
        {
            ...
            if (this.streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界  NetReader: getSByte ");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getSByte");
                    return 0;
                }
        ...
        public short getShort()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getShort");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getShort");
                    return 0;
                }
        ...
        public ushort getUShort()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getUShort");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getUShort");
                    return 0;
                }
        ...
        public int getInt()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getInt" + ActionId);
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getInt" + ActionId);
                    return 0;
                }
        ...
        public uint getUInt()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getUInt");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getUInt");
                    return 0;
                }
        ...
        public float getFloat()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getFloat");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getFloat");
                    return 0;
                }
        ...
        public double getDouble()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getDouble");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getDouble");
                    return 0;
                }
        ...
        public ulong getULong()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getULong");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getULong");
                    return 0;
                }
        ...
        public Int64 readInt64()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: readInt64");
                return 0;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: readInt64");
                    return 0;
                }
        ...
        public DateTime getDateTime()
        {
            ...
            if (streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getDateTime");
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getDateTime");
                    return DateTime.MinValue;
                }
        ...
        public string getString(int nLen)
        {
            if (this.streamPos + nLen > this.bytes.Length)
            {
                Console.WriteLine(" Failed: 长度越界 NetReader: getString");
                return null;
            }
            ...
            if (this.RecordStack.Count > 0)
            {
                ...
                if (info.RecordReadSize + nLen > info.RecordSize)
                {
                    Console.WriteLine(" Failed: 记录长度越界 NetReader: getString");
                    return null;
                }
